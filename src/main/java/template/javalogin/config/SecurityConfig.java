package template.javalogin.config;
...
import template.javalogin.Filter.JwtAuthenticationFilter;
import template.javalogin.service.UserDetailsServiceImp;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5258")); // Allow your front-end domain
